...
import all_Projects.A_CodeTest.ExcelDataProvider;
...
public class TestCode_ExtentReport
{	//After Moving to Remote machine
	// Code Version 12/12/22 
	...
	String DriverPathEdge = "IO/Drivers/msedgedriver108.exe";
	String DriverPathFirefox = "IO/Drivers/geckodriver.exe";
	String DriverPathChrome = "IO/Drivers/chromedriver109.exe";
	...
	public void startTest() throws InterruptedException, Exception
	{
		...
		lib.Recorder.startRecord(Application);
	...
	//PERFORMING OPERAITON START
		...
		//Excel 2nd Sheet Operation Start 
						...
						if(ObjectType.equalsIgnoreCase("Browser"))
						{
							if (Action.equalsIgnoreCase("StartBrowser"))
							{
									...
									
								{
									...
									/*
									 * ChromeOptions optionsBeta = new ChromeOptions(); optionsBeta.
									 * setBinary("C:\\Program Files\\Google\\Chrome Beta\\Application\\chrome.exe");
									 * System.setProperty("webdriver.chrome.driver", DriverPathChrome); WebDriver
									 * driver = new ChromeDriver(optionsBeta); driver.get("google.com")
									 */;
						...
						if(ObjectType.equalsIgnoreCase("Utility"))
						 {
						   if(Action.equalsIgnoreCase("CompareText"))
							...
							if (status.equalsIgnoreCase("Pass"))
								...
								// Helps Tool - Import & Update Member

								if(ObjectType.equalsIgnoreCase("Utility"))
								 {
								   if(Action.equalsIgnoreCase("choosefile"))
								       {
								 
								 Pattern log = new Pattern("C:\\Users\\helpsautotest\\OneDrive - VNSNY\\Desktop\\Testing\\Automation\\Selenium\\Project\\IO\\TestCases\\Helpstool\\Helpstool/cf.png");
							     ...
							     Pattern FileName = new Pattern("C:\\Users\\helpsautotest\\OneDrive - VNSNY\\Desktop\\Testing\\Automation\\Selenium\\Project\\IO\\TestCases\\Helpstool\\FileNameType.png");
								 							    
								 Thread.sleep(5000);
								    
								 screen.wait(FileName);
								 screen.click(FileName);
							     screen.type(".\\Desktop\\utt Solutions RFI - Mock Comprehensive Report XLS.xls");
								      
							     Pattern OpenFile = new Pattern("C:/Users/helpsautotest/Desktop/Automation/Project/IO/TestCases/Helpstool/OpenFile.png");
							     ...
							     Thread.sleep(4000);
									...
									// Helps Tool - Import & Update Member
											...
											if(ObjectType.equalsIgnoreCase("Helps"))
											 {
										    ...
										    Pattern PrintIcon = new Pattern("C:\\Users\\helpsautotest\\OneDrive - VNSNY\\Desktop\\Testing\\Automation\\Selenium\\Project\\IO\\TestCases\\Helpstool\\PrinterIcon.png");
										    Thread.sleep(5000);
										  
										
										    screen.wait(PrintIcon);
											screen.click(PrintIcon);	   
												   
											System.out.println(""+Testcases +":  "   +Description +":  ");
												 
												   
											Pattern PrintButton = new Pattern("C:\\Users\\helpsautotest\\OneDrive - VNSNY\\Desktop\\Testing\\Automation\\Selenium\\Project\\IO\\TestCases\\Helpstool\\PrintButton.png");
											
											 Thread.sleep(5000);
											   
											 screen.wait(PrintButton);
				...
				//	recorder.stop();
					...
					lib.Recorder.stopRecord();
		 }
		private String OpenApplication(WebDriver driver2, String testData) {
